...
import pumaModel1 from '../../assets/puma/1.webp'
import pumaModel2 from '../../assets/puma/2.jpg'
import pumaModel3 from '../../assets/puma/3.jpg'
            ...
            <S.Gallery>
                { pumaArr.map(( e, index ) => {
                    return (<div key={ index }>
                        <NavLink to={ `/puma/${ e.id }` }><img src={ e.picture }
                                                                 alt={ e.model } /></NavLink>
                    </div>)
                }) }
